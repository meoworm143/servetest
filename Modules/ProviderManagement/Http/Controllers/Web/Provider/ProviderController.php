...
class ProviderController extends Controller
{
    ...
    public function __construct(ChannelList $channelList, Transaction $transaction, SubscribedService $subscribedService, BankDetail $bankDetail, Provider $provider, Account $account, User $user, PushNotification $pushNotification, Serviceman $serviceman, Booking $booking, Zone $zone, Review $review, Service $service, SubscribedService $subscribed_service, BankDetail $bank_detail)
    {
    ...
    public function get_updated_data(Request $request): JsonResponse
    {
        ...
        $booking = $this->booking->whereIn('sub_category_id', $subscribed)->where('is_checked', 0)->count();
