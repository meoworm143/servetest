        ...
        if (isset($booking)) {
            ...
            if ($request->has('file')) {
                if($booking->booking_status == "ongoing"){
                    $booking->start_image = file_uploader('bookings/', 'png', $request->file('file'), $booking->start_image);
                    $booking_status_history->start_image = $booking->start_image;
                     $booking_status_history->image = $booking->start_image;
                }else if($booking->booking_status == "completed"){
                    $booking->complete_image = file_uploader('bookings/', 'png', $request->file('file'), $booking->complete_image);
                    $booking_status_history->complete_image = $booking->complete_image;
                    $booking_status_history->image = $booking->complete_image;
                }
