...
{{--                                                <label class="lh-1" for="remember">{{translate('remember_me')}}</label>--}}
                                            ...
                                            <div class="d-flex gap-1 align-items-center">
                                                @if((business_config('provider_self_registration', 'service_setup'))->live_values)
                                                    <a class="lh-1" href="{{route('provider.auth.sign-up')}}">{{translate('Create_provider_account')}}</a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
