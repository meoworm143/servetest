...
<div class="messaging">
    <div class="inbox_msg" style="display: flex;flex-direction: column-reverse;">
            ...
            <div class="input_msg_write">
                ...
                <div class="send-msg-btns d-flex justify-content-end">
                    <div class="add-img">
                        ...
                        <input type="file" class="file_input" name="files[]">
                    </div>
...
<script>
    ...
    //Upload File
    $(".type_msg .file_input").on("change", function (e) {
        var filename = $(e.target).val().split('\\').pop();
        $(".messaging .inbox_msg").prepend( "<span class='show-upload-file'>" + filename + "</span>" );
