                                    ...
                                    <section>
                                        <div class="row">
                                            <div class="col-lg-5 mb-5 mb-lg-0">
                                                ...
                                                <div class="mb-30">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" name="admin_commission" min="0"
                                                               max="100" step="0.01"
                                                               placeholder="Admin Commission"
                                                               required="" value="{{$service->admin_commission?? ""}}">
                                                        <label>Admin Commission (Percentage) *</label>
                                                    </div>
                                                </div>
                                                     <div class="mb-30">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" name="booking_fee" min="0"
                                                               step="0.01"
                                                               placeholder="Booking Fee"
                                                               required="" value="{{$service->booking_fee?? ""}}">
                                                        <label>Booking Fee (Fixed) *</label>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <section>
                                        <div class="d-flex flex-wrap gap-20 mb-3">
                                            <div class="form-floating flex-grow-1">
                                                <div class="mb-30">
                                                    <select class="js-select theme-input-style w-100" name="variant_name" id="variant-name">
                ...
                $.get({
                    ...
                    success: function (response) {
                        ...
                        if (response.flag == 0) {
                            ...
                            toastr.info('Alread have variant');
                        } else {
