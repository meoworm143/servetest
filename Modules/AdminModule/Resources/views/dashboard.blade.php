                ...
                <div class="row mb-4 g-4">
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="business-summary business-summary-earning">
                            <h2>{{with_currency_symbol($data[0]['top_cards']['total_commission_earning'])}}</h2>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="business-summary business-summary-customers">
                            <h2>{{with_currency_symbol($data[0]['top_cards']['total_system_earning'])}}</h2>
                            <h3>{{translate('total_earning')}} of Provider</h3>
            ...
            series: [
                {
                    ...
                    data: {{json_encode($data[1]['earning_stats'])}}
                },
                {
                    name: "{{translate('admin_commission')}}",
                    data: {{json_encode($data[1]['commission_stats'])}}
                }
            ],
            chart: {
                height: 386,
